...
class AppPadding {
  ...
  static const SizedBox sizedBoxVerticalSmall = SizedBox(height: 8.0);
  static const SizedBox sizedBoxVerticalRegular = SizedBox(height: 16.0);
  static const SizedBox sizedBoxVerticalLarge = SizedBox(height: 32.0);
}
